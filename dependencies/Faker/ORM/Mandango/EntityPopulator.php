...
class EntityPopulator
{
     ...
     * @return array
     */
    public function guessColumnFormatters(\Beer_List\Dependencies\Faker\Generator $generator, Mandango $mandango)
    {
        $formatters = [];
        $nameGuesser = new \Beer_List\Dependencies\Faker\Guesser\Name($generator);
        $columnTypeGuesser = new \Beer_List\Dependencies\Faker\ORM\Mandango\ColumnTypeGuesser($generator);
