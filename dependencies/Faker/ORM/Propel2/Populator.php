...
class Populator
{
    ...
    public function __construct(\Beer_List\Dependencies\Faker\Generator $generator)
    {
     ...
     *
     * @param mixed $entity A Propel ActiveRecord classname, or a \Beer_List\Dependencies\Faker\ORM\Propel2\EntityPopulator instance
     * @param int   $number The number of entities to populate
     */
    public function addEntity($entity, $number, $customColumnFormatters = [], $customModifiers = [])
    {
        if (!$entity instanceof \Beer_List\Dependencies\Faker\ORM\Propel2\EntityPopulator) {
            $entity = new \Beer_List\Dependencies\Faker\ORM\Propel2\EntityPopulator($entity);
        }
