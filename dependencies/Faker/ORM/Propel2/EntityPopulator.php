...
namespace Beer_List\Dependencies\Faker\ORM\Propel2;

use Beer_List\Dependencies\Faker\Provider\Base;
...
class EntityPopulator
{
     ...
     * @return array
     */
    public function guessColumnFormatters(\Beer_List\Dependencies\Faker\Generator $generator)
    {
        $formatters = [];
        $class = $this->class;
        $peerClass = $class::TABLE_MAP;
        $tableMap = $peerClass::getTableMap();
        $nameGuesser = new \Beer_List\Dependencies\Faker\Guesser\Name($generator);
        $columnTypeGuesser = new \Beer_List\Dependencies\Faker\ORM\Propel2\ColumnTypeGuesser($generator);
     ...
     * @return array
     */
    public function guessModifiers(\Beer_List\Dependencies\Faker\Generator $generator)
    {
        $modifiers = [];
        $class = $this->class;
        $peerClass = $class::TABLE_MAP;
