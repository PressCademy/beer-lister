...
namespace Beer_List\Dependencies\Faker\ORM\Doctrine;
...
class Populator
{
     ...
     *
     * @param mixed $entity A Doctrine classname, or a \Beer_List\Dependencies\Faker\ORM\Doctrine\EntityPopulator instance
     * @param int   $number The number of entities to populate
     */
    public function addEntity($entity, $number, $customColumnFormatters = [], $customModifiers = [], $generateId = false)
    {
        if (!$entity instanceof \Beer_List\Dependencies\Faker\ORM\Doctrine\EntityPopulator) {
            if (null === $this->manager) {
                throw new \InvalidArgumentException('No entity manager passed to Doctrine Populator.');
            }
            $entity = new \Beer_List\Dependencies\Faker\ORM\Doctrine\EntityPopulator($this->manager->getClassMetadata($entity));
        }
