...
namespace Beer_List\Dependencies\Faker\Provider\ro_RO;

class Person extends \Beer_List\Dependencies\Faker\Provider\Person
{
    ...
    protected function getDateOfBirth($dateOfBirth)
    {
        ...
        $baseDate = \Beer_List\Dependencies\Faker\Provider\DateTime::dateTimeBetween("first day of January {$dateOfBirthParts[0]}", "last day of December {$dateOfBirthParts[0]}");
