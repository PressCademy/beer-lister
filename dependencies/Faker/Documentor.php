...
namespace Beer_List\Dependencies\Faker;
    ...
    public function getFormatters()
    {
        ...
        foreach ($providers as $provider) {
            ...
            foreach ($refl->getMethods(\ReflectionMethod::IS_PUBLIC) as $reflmethod) {
                if ($reflmethod->getDeclaringClass()->getName() == 'Beer_List\Dependencies\Faker\Provider\Base' && $providerClass != 'Beer_List\Dependencies\Faker\Provider\Base') {
                    continue;
                }
