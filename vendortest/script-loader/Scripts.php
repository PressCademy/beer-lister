...
namespace Test_Scripts\Loaders;
...
class Scripts extends Loader_Registry {
	 ...
	 * @inheritDoc
	 */
	protected $abstraction_class = '\Test_Scripts\Abstracts\Script';

	protected $default_factory = '\Test_Scripts\Factories\Script_Instance';
