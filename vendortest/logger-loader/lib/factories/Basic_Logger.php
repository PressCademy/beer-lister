...
namespace Test_Logger\Factories;


use Test_Logger\Abstracts\Event_Type;
use Test_Logger\Abstracts\Writer;
use WP_Error;
...
class Basic_Logger extends Writer {
	...
	public function __construct( Event_Type $event_type ) {
		...
		$this->log_dir = trailingslashit( trailingslashit( $upload_dir['basedir'] ) . 'test-event-logs/' );
