...
namespace Test_Logger\Abstracts\Registries;


use Exception;
use Test\Abstracts\Event_Type;
...
abstract class Event_Registry extends Loader_Registry {
	 ...
	 * @inheritDoc
	 */
	protected $abstraction_class = 'Test_Logger\Abstracts\Event_Type';

	protected $default_factory = 'Test_Logger\Factories\Event_Type_Instance';
