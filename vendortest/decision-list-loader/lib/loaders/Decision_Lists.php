...
namespace Test_Decision_Lists\Loaders;
...
class Decision_Lists extends Loader_Registry {
	 ...
	 * @inheritDoc
	 */
	protected $abstraction_class = 'Test_Decision_Lists\Abstracts\Registries\Decision_List';

	protected $default_factory = 'Test_Decision_Lists\Factories\Decision_List_Instance';
	...
	public function decide( $key, $params ) {
		...
		if ( is_wp_error( $decision_list ) ) {
			test()->logger()->log_wp_error( 'error', $decision_list );
